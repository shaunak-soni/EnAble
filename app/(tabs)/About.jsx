    ...
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.content}>
        ...
        <Text style={styles.description}>
          Designed with compassion and dignity at its core, EnAble empowers individuals with disabilities 
          to live more independently and confidently. It features listings of disability-friendly homes and shows nearby transportation, 
        ...
        <Text style={styles.description}>
          However, the obstacles that he and others with disabilities face go much beyond just housing. 
